...
export = class ChromiumIstanbul extends CoverageReporter {
    ...
    constructor(globalConfig: Config.GlobalConfig, _options?: any) {
        ...
        // the origin CoverageReporter doesn't include chromium information.
        ...
        process.env.JEST_PLAYWRIGHT_ISTANBUL_DIR = globalConfig.coverageDirectory
        process.env.JEST_PLAYWRIGHT_ISTANBUL_COVERAGE = this.collectCoverage ? "true" : "false"
